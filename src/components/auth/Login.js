...
function Login() {
  ...
  >Please login to start your journey</button>
    : <button onClick={logout} type="button" className="inline-flex items-center mt-5 px-6 py-3 border border-transparent shadow-sm text-base font-medium rounded-md text-white bg-cyan-900 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
    >Logout</button>
}
